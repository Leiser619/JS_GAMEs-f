...
function staty(){
    ...
    enemy_health=res.forest[localStorage.getItem("enemy_forest")].health
    enemy_magic=res.forest[localStorage.getItem("enemy_forest")].magic
    enemy_defence=res.forest[localStorage.getItem("enemy_forest")].defence
    enemy_attack_speed=res.forest[localStorage.getItem("enemy_forest")].attack_speed
    enemy_attack=res.forest[localStorage.getItem("enemy_forest")].attack
    enemy_weapon=res.forest[localStorage.getItem("enemy_forest")].weapon
    enemy_spell=res.forest[localStorage.getItem("enemy_forest")].spell
    ...
    enemyA.innerHTML ="<img src="+res.forest[localStorage.getItem("enemy_forest")].avatar+" id='hero_fight'></img>"
...
function walka(){
    ...
    if (i == 0) {
        ...
        function hero_ma(){
            ...
            document.getElementById('forest').appendChild(enemy_spell_img);
        ...
        if (hero_health <=0) {
            ...
            document.getElementById('forest').appendChild(popu);
            ...
            document.getElementById('forest').appendChild(enemy_weapon_img);
    ...
    if (a == 0) {
        ...
        function enemy_ma(){
            ...
            document.getElementById('forest').appendChild(hero_spell_img);
        ...
        if (enemy_health <=0) {
            ...
            document.getElementById('forest').appendChild(hero_weapon_img);
    ...
    function powrot_punkty(){
        ...
        document.cookie="exp="+res.forest[localStorage.getItem("enemy_forest")].exp

        document.cookie="gold="+res.forest[localStorage.getItem("enemy_forest")].gold
