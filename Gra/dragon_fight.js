...
const convert2="dragon_"+localStorage.getItem("enemy_dragon")+".png"
...
function staty(){
    ...
    enemy_health=res.dragon[localStorage.getItem("enemy_dragon")].health
    enemy_magic=res.dragon[localStorage.getItem("enemy_dragon")].magic
    enemy_defence=res.dragon[localStorage.getItem("enemy_dragon")].defence
    enemy_attack_speed=res.dragon[localStorage.getItem("enemy_dragon")].attack_speed
    enemy_attack=res.dragon[localStorage.getItem("enemy_dragon")].attack
    enemy_weapon=res.dragon[localStorage.getItem("enemy_dragon")].weapon
    enemy_spell=res.dragon[localStorage.getItem("enemy_dragon")].spell
    ...
    enemyA.innerHTML ="<img src="+res.dragon[localStorage.getItem("enemy_dragon")].avatar+" id='hero_fight'></img>"
...
function walka(){
    ...
    if (i == 0) {
        ...
        function hero_ma(){
            ...
            document.getElementById('dragon').appendChild(enemy_spell_img);
        ...
        if (hero_health <=0) {
            ...
            document.getElementById('dragon').appendChild(popu);
            ...
            document.getElementById('dragon').appendChild(enemy_weapon_img);
    ...
    if (a == 0) {
        ...
        function enemy_ma(){
            ...
            document.getElementById('dragon').appendChild(hero_spell_img);
        ...
        if (enemy_health <=0) {
            ...
            document.getElementById('dragon').appendChild(hero_weapon_img);
    ...
    function powrot_punkty(){
        ...
        document.cookie="exp="+res.dragon[localStorage.getItem("enemy_dragon")].exp

        document.cookie="gold="+res.dragon[localStorage.getItem("enemy_dragon")].gold
